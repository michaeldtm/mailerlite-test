<template>
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      ...
      <p class="mt-2 text-sm text-gray-700">A list of all the subscribers including their name, email and state.</p>
    </div>
        ...
        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tr v-for="(subscriber, key) in subscribers" :key="key">
              ...
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ subscriber.email_address }}</td>
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ subscriber.state }}</td>
              <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                <router-link
                  :to="{name: 'SubscriberEdit', params: {id: subscriber.id}}"
